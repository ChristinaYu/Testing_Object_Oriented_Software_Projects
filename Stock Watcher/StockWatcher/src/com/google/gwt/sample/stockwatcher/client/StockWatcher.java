...
public class StockWatcher implements EntryPoint {
  ...
  static FlexTable stocksFlexTable = new FlexTable();
...
/**
 ...
 // Add a button to remove this stock from the table.
   ...
   */
  static void updateTable(StockPrice[] prices) {
 ...
 * @return 
   */
  static double updateTable(StockPrice price) {
